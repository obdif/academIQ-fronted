...
//       } w-64 bg-white/90 backdrop-blur-sm shadow-lg transition-transform duration-300 ease-in-out z-20 pt-16 md:pt-0 md:static md:transform-none md:w-64 md:bg-transparent md:backdrop-blur-none md:shadow-none`}
//     >
//       <div className="p-4">
...
//           </div>
//           <button onClick={onClose} className="text-sm text-[#0EA8FF] hover:text-[#008CE3] md:hidden">
//             <X className="w-6 h-6" />
//           </button>
//         </div>
